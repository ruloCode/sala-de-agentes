...
export const COPY: Record<EstLanguage, Record<string, string>> = {
  es: {
    ...
    source: "Fuente",
    kindBarrio: "barrio",
    kindDireccion: "dirección",
    kindLugar: "lugar",
    kindEstacion: "estación",
  ...
  en: {
    ...
    boardAt: "Board at",
    source: "Source",
    kindBarrio: "neighborhood",
    kindDireccion: "address",
    kindLugar: "place",
    kindEstacion: "station",
  ...
  pt: {
    ...
    source: "Fonte",
    kindBarrio: "bairro",
    kindDireccion: "endereço",
    kindLugar: "lugar",
    kindEstacion: "estação",
    here: "nesta estação",
